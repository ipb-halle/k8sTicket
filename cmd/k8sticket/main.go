...
func main() {
	...
	deploymentController.Informer.AddEventHandler(k8sfunctions.NewDeploymentHandlerForK8sconfig(deploymentController.Clientset, namespace, proxymap, &metric))
	...
	deploymentMetaController.Informer.AddEventHandler(k8sfunctions.NewMetaDeploymentHandlerForK8sconfig(deploymentController.Clientset, namespace, proxymap, &metric))
